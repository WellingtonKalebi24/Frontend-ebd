...
export const Oferta = () => {
    ...
    if (!isAuthenticated) {
       ...
       async function handleOfertante(e){
        e.preventDefault();
    ...
    onClick={handleNavigate}>Voltar</button>
        ...
        <form className="max-w-sm mx-auto" onSubmit={handleOfertante}>
            <div className="mb-5">
            <label htmlFor="oferta" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">* Oferta</label>
            <input
