...
export const MenuSecretario = () => {
    ...
    return (
        ...
        <div className="m-40 max-w-sm mx-auto">
            ...
            <Link to="/menu_user/secretario_rel" className="mt-8 block max-w-sm p-6 bg-amber-300 border border-gray-200 rounded-lg shadow-md hover:bg-amber-400 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
